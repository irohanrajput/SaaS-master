-- Migration script to update competitor_cache table structure
-- Run this in Supabase SQL Editor

-- Step 1: Drop the old table (WARNING: This will delete all cached data)
DROP TABLE IF EXISTS competitor_cache CASCADE;

-- Step 2: Create new table with separated columns
...
-- Step 5: Grant necessary permissions (adjust based on your RLS policies)
-- If you have RLS enabled, you may need to add policies here
